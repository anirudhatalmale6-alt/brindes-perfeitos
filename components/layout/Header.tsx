      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/contato" className="text-gray-700 hover:text-lime-600 font-medium text-sm">Contato</Link>
        ...
        {mobileMenu && (
          <nav className="md:hidden mt-4 pb-4 border-t pt-4 space-y-3">
            ...
            <Link href="/contato" className="block text-gray-700 hover:text-lime-600 font-medium">Contato</Link>
          </nav>
        )}
      </div>
    </header>
