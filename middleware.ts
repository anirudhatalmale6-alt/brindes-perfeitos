...
export const config = {
  matcher: ['/admin/:path*', '/api/products/:path*', '/api/categories/:path*', '/api/banners/:path*', '/api/import/:path*', '/api/settings/:path*', '/api/seo/:path*', '/api/pricing/:path*', '/api/upload/:path*'],
};
