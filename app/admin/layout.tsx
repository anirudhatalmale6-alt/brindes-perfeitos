    ...
    <div className="min-h-screen bg-gray-100 flex">
      <aside className="w-64 bg-white shadow-md flex flex-col">
        <div className="p-4 border-b">
          <Link href="/" className="text-lg font-bold text-blue-600">Brindes Perfeitos</Link>
        ...
        <div className="p-4 border-t">
          ...
          <Link href="/" className="block mt-2 text-sm text-blue-600 hover:underline">Ver Site</Link>
        </div>
      </aside>
